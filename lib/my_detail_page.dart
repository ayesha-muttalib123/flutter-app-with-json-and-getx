...
import 'package:getxproject/detailcontroller.dart';
...
class _DetailPageState extends State<DetailPage> {
  //now injecting this fav detailcontroller here
                ...
                child: Row(
                  children: [
                    Container(
                        ...
                        child: IconButton(
                            onPressed: () {
                              fav.favCounter();    //calling its function
                            },
                            icon: Icon(
